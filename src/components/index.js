...
import { View, Center, HStack, Icon, Pressable, Text, Stack, Button, Spinner, Image, Avatar } from "native-base"
import { StyleSheet, TouchableOpacity } from "react-native"
import normalize from "react-native-normalize"
import { navigate, navigator } from "../redux/services"
import { COLOR, LAYOUT, ROOT } from "../constants"
    ...
    <HStack bg={COLOR.base} alignItems="center" safeAreaBottom shadow={3}>
      ...
      >
        <Center>
          ...
          <Text color="white" fontSize='xs'>Markets</Text>
        </Center>
      </Pressable>
      <Center pos='absolute' w='100%'>
        <TouchableOpacity>
          <Center shadow={2} borderRadius={100} w={70} h={70} marginTop={-normalize(10)} bg={COLOR.base}>
            ...
            <Text color="white" fontSize='xs'>Trade</Text>
          </Center>
        </TouchableOpacity>
      </Center>
      <Pressable w={70} />
      ...
      >
        <Center>
          ...
          <Text color="white" fontSize='xs'>Copy Trade</Text>
        </Center>
      </Pressable>
      <Pressable
        py={2}
      ...
      >
        <Center>
          ...
          <Text color="white" fontSize='xs'>Assets</Text>
        </Center>
      </Pressable>
    </HStack>
  )
